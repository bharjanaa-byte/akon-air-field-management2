...
async function importMessage(integration, token, messageId) {
  ...
  // A dispatch import is intentionally add-only. Existing work orders can be
  // edited in the app, but Gmail must never silently change a saved job.
  return { imported: fresh.length, updated: 0 };
}
